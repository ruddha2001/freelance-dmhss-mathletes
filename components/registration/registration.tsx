...
export default function Registration() {
  ...
  return (
    <div className="bg-white px-7 md:px-12 lg:px-96 mt-10">
      <FormikProvider value={formik}>
        <form onSubmit={formik.handleSubmit}>
          ...
          {formik.touched.schoolName && formik.errors.schoolName ? (
            <div className="-mt-3 text-red-600">{formik.errors.schoolName}</div>
          ) : null}
          ...
          <button
            type="submit"
            className="text-sm md:text-xl bg-yellow-500 p-4 rounded-xl mx-auto block"
          >
            Submit
          </button>
        </form>
