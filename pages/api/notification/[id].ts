...
</tr><tr style="border-collapse:collapse"><td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333">Congratulations!</h2></td>
</tr><tr style="border-collapse:collapse"><td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">You have successfully registered for Douglas Mathletes 2021.<br>Your Unique Registration Code is <strong>{{=it.code}}</strong>.<br><br>This code will be required by all your participants while joining the meetings. The display name should be in the format 'Name+Unique code'.<br>If you have any queries, please reply to this email and we shall get back to you.</p></td></tr></table></td></tr></table></td></tr></table></td>
        ...
        const mail: SendEmailRequest = {
          Content: {
            Simple: {
              Body: {
                Html: {
                  Data: getTemplate({ code: req.query.id }),
                },
                Text: {
              ...
              Subject: {
                Data: `Douglas Mathletes 2021 - Registration Confirmation`,
              },
            },
          },
          Destination: {
